 ...
 */
class ReceptionNoticeBoardRecyclerViewAdapter(var context: Context?,
                                              noticeList: MutableList<NoticeBoard?>?) :
        RecyclerView.Adapter<ReceptionNoticeBoardRecyclerViewAdapter
    ...
    override fun onCreateViewHolder(parent: ViewGroup, pos: Int):
            ReceptionNoticeBoardRecyclerViewAdapter.InmatesSickLeaveRecyclerViewHolder {
    ...
    override fun onBindViewHolder(holderInmatesSickLeave: ReceptionNoticeBoardRecyclerViewAdapter
    .InmatesSickLeaveRecyclerViewHolder, pos: Int) {
        ...
        holderInmatesSickLeave.item?.setOnClickListener {
            val intent = Intent(context, ReceptionNoticeBoardDetailsActivity::class.java)
